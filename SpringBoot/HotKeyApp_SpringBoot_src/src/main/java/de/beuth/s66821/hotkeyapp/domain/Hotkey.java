...
public class Hotkey implements Serializable {
	...
	/**
	 * Constructor for Hotkey
	 * @param ident name of the key
	 * @param combo is the key combination
	 */
	public Hotkey(String ident, String combo) {
		this.identifier = ident;
		this.keyCombination = combo;
	}
	
	/**
	 * Getter for keyCombination
	...
	/**
	 * Setter for keyCombination
	 * @param combo the shortcuts in a string
	 */
     ...
     */
    public boolean isValidKeypress(final Hotkey hotkey){
        final String[] keys = hotkey.getKeyCombination().split(" ");
	...
	/**
	 * toString for Hotkey
	 * @return toString for Hotkey
	 */
	public String toString() {
	//return "Hotkey: " + this.keyCombination;
